      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 shadow-md rounded-lg text-center">
            ...
            <p>
              הצימרים ממוקמים בקרבה גבוהה למרכז הארץ. המיקום המדויק יישלח
              לאחר סגירת ההזמנה.
            </p>
            ...
            <p>
              <strong>בקרבת מקום (5 דקות נסיעה):</strong>
            </p>
            <ul>
              <li>
                <a
          ...
          <div className="bg-white p-6 shadow-md rounded-lg text-center">
            ...
            <p className="text-gray-600 mb-4">אנחנו כאן בשבילכם</p>
